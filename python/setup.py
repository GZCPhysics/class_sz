...
classy_ext = Extension("classy_sz", [os.path.join(classy_folder, "classy.pyx")],
                           ...
                           extra_link_args=['-lomp','-L/Users/aleksandra/software/gsl-2.7.1/lib/','-lgsl','-L/Users/aleksandra/software/fftw-3.3.10/lib/', '-lfftw3','-lgslcblas','-Wl,-rpath,/opt/homebrew/opt/gcc/lib/gcc/12/',"-L/Users/aleksandra/anaconda3/lib/"]) # BB
